...
void main() {
  group("Valid data model", () {
    ...
    test("Relationships have appropriate values set", () {
      ...
      expect(
          relDesc.inverse ==
              dataModel
                  .entityForType(Manager).relationships![relDesc.inverseKey],
          true);
      expect(
    ...
    test("Managed objects can have foreign key references to one another", () {
      ...
      expect(
          dm
              .entityForType(CyclicLeft).relationships!["leftRef"]!
              .destinationEntity!
              .name,
          "CyclicRight");
      ...
      expect(
          dm
              .entityForType(CyclicLeft).relationships!["from"]!
              .destinationEntity!
              .name,
          "CyclicRight");
      ...
      expect(
          dm
              .entityForType(CyclicRight).relationships!["rightRef"]!
              .destinationEntity!
              .name,
          "CyclicLeft");
      expect(
      ...
      expect(
          dm
              .entityForType(CyclicRight).relationships!["from"]!
              .destinationEntity!
              .name,
          "CyclicLeft");
    ...
    test("Managed objecs can have foreign key references to themselves", () {
      ...
      expect(
          dm
              .entityForType(SelfReferential).relationships!["parent"]!
              .destinationEntity!
              .name,
          "SelfReferential");
      expect(
      ...
      expect(
          dm
              .entityForType(SelfReferential).relationships!["child"]!
              .destinationEntity!
              .name,
          "SelfReferential");
      expect(
  ...
  group("Edge cases", () {
    test("ManagedObject with two foreign keys to same object are distinct", () {
      ...
      var isManyOf = model
          .entityForType(DoubleRelationshipForeignKeyModel).relationships!["isManyOf"]!;
      ...
      var isOneOf = model
          .entityForType(DoubleRelationshipForeignKeyModel).relationships!["isOneOf"]!;
    ...
    test(
      ...
      var partial = model
          .entityForType(DoubleRelationshipForeignKeyModel).relationships!["partial"]!;
  ...
  group("Valid data model with deferred types", () {
    ...
    test("Partials have defaultProperties from table definition superclasses",
      ...
      expect(
          dataModel
              .entityForType(PartialReferenceModel).defaultProperties!
