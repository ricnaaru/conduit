...
You will need a local database for testing, and another database for running the application locally. The behavior and configuration of these databases are documented here: http://www.theconduit.dev/docs/testing/mixins/.
...
To run your tests with OAuth 2.0 client identifiers, see this documentation: http://www.theconduit.dev/docs/testing/mixins/#testing-applications-that-use-oauth-20.
